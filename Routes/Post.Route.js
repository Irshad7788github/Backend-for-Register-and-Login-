...
Router.get('/post', VerifyTokan, async(req, res)=>{
    try { 
...
Router.post('/post', VerifyTokan, async(req,res)=>{
    try {
...
Router.put('/post/:postid', VerifyTokan, async(req, res)=>{
    try {
...
Router.delete('/post/:postid', VerifyTokan, async(req, res)=>{
    try {
